...
<div class="scrollbar-container main-menu-content ps ps--active-y">
    <ul class="navigation navigation-main">
        <li class="nav-item active"><a href="/petugas"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="avatar avatar-stats p-50 m-0 bg-light-info">
                                    <div class="avatar-content"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-calendar" viewBox="0 0 16 16">
 ...
 - ${i}: ${e}`, h && (l += encodeURI(i) + "=" + encodeURI(e))
            ...
            let T = {
                ...
                getClosestDistance: function(t, e) {
                    ...
                    return t.forEach(t => {
                        if (t.length > 1)
                            for (o = t.length - 1; o > 0; o--)(s = t[o] - t[o - 1]) < 0 && !r ? (e?.(), e = void 0) : s && (void 0 === i || s < i) && (i = s)
                    }), i
                },
                getMagnitude: b,
            ...
            let {
                ...
                credits: {
                    enabled: !0,
                    href: "https://instagram.com/rkh.yg_",
                    position: {
                        align: "right",
                        x: -10,
                        verticalAlign: "bottom",
            ...
            class r {
                ...
                init(t) {
                    let e, i, s, o;
                    if ("object" == typeof t && void 0 !== t.stops) this.stops = t.stops.map(t => new r(t[1]));
                        ...
                        if (!i)
                            for (s = r.parsers.length; s-- && !i;)(e = (o = r.parsers[s]).regex.exec(t)) && (i = o.parse(e))
                    }
                    i && (this.rgba = i)
                }
                get(t) {
                ...
                brighten(t) {
                    ...
                    if (this.stops) this.stops.forEach(function(e) {
                        ...
                        for (let i = 0; i < 3; i++) e[i] += o(255 * t), e[i] < 0 && (e[i] = 0), e[i] > 255 && (e[i] = 255);
                    return this
                }
                setOpacity(t) {
            ...
            function g(t, e, s, o) {
                ...
                let h = i.lang,
                    ...
                    u = e; - 1 === e ? e = Math.min(l, 20) : a(e) ? e && p[1] && p[1] < 0 && ((n = e + +p[1]) >= 0 ? (p[0] = (+p[0]).toExponential(n).split("e")[0], e = n) : (p[0] = p[0].split(".")[0] || 0, t = e < 20 ? (p[0] * Math.pow(10, p[1])).toFixed(e) : 0, p[1] = 0)) : e = 2;
            ...
            class D {
                ...
                getBBox(t, e) {
                    ...
                    let {
                        ...
                        cache: u,
                        cacheKeys: g
                    } = d, f = l.namespaceURI === this.SVG_NS, y = A(e, this.rotation, 0), v = d.styledMode ? l && D.prototype.getStyle.call(l, "font-size") : c && c.fontSize;
            ...
            return {
                ...
                callout: function(t, e, s, o, r) {
                    ...
                    if (t + l > s - h) {
                        if (d > e + h && d < e + o - h) c.splice(3, 1, ["L", t + s, d - 6], ["L", t + s + 6, d], ["L", t + s, d + 6], ["L", t + s, e + o - a]);
                        else if (l < s) {
                            let i = d < e + h,
                                r = i ? e : e + o;
                        ...
                        if (d > e + h && d < e + o - h) c.splice(7, 1, ["L", t, d + 6], ["L", t - 6, d], ["L", t, d - 6], ["L", t, e + a]);
                        else if (l > 0) {
                            let i = d < e + h,
                                s = i ? e : e + o;
            ...
            return class {
                ...
                addLabel() {
                    let e = this,
                        ...
                        v = m.info,
                        k = e.label,
                        S, M, C, w = this.parameters.category || (a ? u(a[g], p[g], g) : g);
            ...
            let {
                ...
                splat: I,
                syncTimeout: B
            } = a, j = (t, e) => P(e, void 0, void 0, O(t.options.allowDecimals, e < .5 || void 0 !== t.tickAmount), !!t.tickAmount);
            class R {
                constructor(t, e, i) {
                ...
                defaultLabelFormatter(t) {
                    ...
                    if (n) f = `${this.value}`;
                        ...
                        for (; u-- && void 0 === f;) p >= (g = Math.pow(c, u + 1)) && 10 * o % g == 0 && null !== d[u] && 0 !== o && (f = s(o / g, -1) + d[u]);
                        ...
                        e.hasVisibleSeries = !1, e.dataMin = e.dataMax = e.threshold = null, e.softThreshold = !e.isXAxis, e.series.forEach(function(i) {
                            if (i.reserveSpace()) {
                                let s = i.options,
                                    o, r = s.threshold,
                                    n, a;
                                if (e.hasVisibleSeries = !0, e.positiveValuesOnly && r <= 0 && (r = null), e.isXAxis)(o = i.xData) && o.length && (o = e.logarithmic ? o.filter(t => t > 0) : o, n = (t = i.getXExtremes(o)).min, a = t.max, w(n) || n instanceof Date || (o = o.filter(w), n = (t = i.getXExtremes(o)).min, a = t.max), o.length && (e.dataMin = Math.min(O(e.dataMin, n), n), e.dataMax = Math.max(O(e.dataMax, a), a)));
                                else {
                ...
                getPlotLinePath(t) {
                    ...
                    return k(this, "getPlotLinePath", v, function(t) {
                        u = m = Math.round((c = g(c = O(c, e.translate(n, void 0, void 0, r)), -1e5, 1e5)) + d), f = x = Math.round(h - c - d), w(c) ? e.horiz ? (f = o, x = h - e.bottom, u = m = b(u, s, s + e.width)) : (u = s, m = l - e.right, f = x = b(f, o, o + e.height)) : (y = !0, p = !1), t.path = y && !p ? void 0 : i.renderer.crispLine([
                            ["M", u, f],
                            ["L", m, x]
                        ], a || 1)
                    }), v.path || null
                ...
                getMinorTickPositions() {
                    ...
                    if (n && n / i < this.len / 3) {
                        ...
                        if (s) this.paddedTicks.forEach(function(t, e, o) {
                            ...
                            for (h = o + (e[0] - o) % i; h <= r && h !== a[0]; h += i) a.push(h)
                    }
                ...
                setTickInterval(t) {
                    let e = this.chart,
                        ...
                        l = s.maxPadding,
                        d = s.minPadding,
                        c, p, u = w(s.tickInterval) && s.tickInterval >= 0 ? s.tickInterval : void 0,
                ...
                setTickPositions() {
                    let t = this.options,
                        ...
                        h = [],
                        l;
                    if (this.tickmarkOffset = this.categories && "between" === t.tickmarkPlacement && 1 === this.tickInterval ? .5 : 0, this.minorTickInterval = "auto" === s && this.tickInterval ? this.tickInterval / t.minorTicksPerMajor : s, this.single = this.min === this.max && m(this.min) && !this.tickAmount && (parseInt(this.min, 10) === this.min || !1 !== t.allowDecimals), e) h = e.slice();
                    else if (w(this.min) && w(this.max)) {
                        if ((!this.ordinal || !this.ordinal.positions) && (this.max - this.min) / this.tickInterval > Math.max(2 * this.len, 200)) h = [this.min, this.max], b(19, !1, this.chart);
                        else if (this.dateTime) h = this.getTimeTicks(this.dateTime.normalizeTimeTickInterval(this.tickInterval, t.units), this.min, this.max, t.startOfWeek, this.ordinal && this.ordinal.positions, this.closestPointRange, !0);
                            ...
                            let t = this.tickInterval,
                                e = t;
                            for (; e <= 2 * t;)
                                if (h = this.getLinearTickPositions(this.tickInterval, this.min, this.max), this.tickAmount && h.length > this.tickAmount) this.tickInterval = j(this, e *= 1.1);
                                else break
                        }
                ...
                renderUnsquish() {
                    ...
                    if (T(o.rotation) || (l.rotation = o.rotation || 0), i.forEach(function(t) {
                        ...
                        for (u = "clip", m = i.length; !n && m--;)(f = s[i[m]].label) && (f.styles && "ellipsis" === f.styles.textOverflow ? f.css({
                            textOverflow: "clip"
                ...
                class h {
                    ...
                    getLogTickPositions(t, e, i, r) {
                        let n = this.axis,
                            ...
                            h = n.options,
                            l = [];
                        if (r || (this.minorAutoInterval = void 0), t >= .5) t = Math.round(t), l = n.getLinearTickPositions(t, e, i);
                        else if (t >= .08) {
                            let s, o, n, a, h, d, c;
                            let p = Math.floor(e);
                            for (s = t > .3 ? [1, 2, 4] : t > .15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9], o = p; o < i + 1 && !c; o++)
                                for (n = 0, a = s.length; n < a && !c; n++)(h = this.log2lin(this.lin2log(o) * s[n])) > e && (!r || d <= i) && void 0 !== d && l.push(d), d > i && (c = !0), d = h
                        } else {
            ...
            class S {
                ...
                getAnchor(t, e) {
                    ...
                    let s = this.chart,
                        ...
                        n = s.plotTop,
                        a = s.plotLeft;
                    if ((t = v(t))[0].series && t[0].series.yAxis && !t[0].series.yAxis.options.reversedStacks && (t = t.slice().reverse()), this.followPointer && e) void 0 === e.chartX && (e = o.normalize(e)), i = [e.chartX - a, e.chartY - n];
                ...
                refresh(t, e) {
                    ...
                    let M = x(d) ? r(d, m, i) : c.call(m, this),
                        C = h.series;
                    if (this.distance = b(C.tooltipOptions.distance, 16), !1 === M) this.hide();
                    else {
                ...
                updatePosition(t) {
                    let {
                        ...
                        height: n = 0,
                        width: a = 0
                    } = this.getLabel(), h = e.pointer, {
                        left: l,
                        top: d,
                        scaleX: p,
                        scaleY: u
                    } = h.getChartPosition(), g = (o.positioner || this.getPosition).call(this, a, n, t), f = (t.plotX || 0) + e.plotLeft, m = (t.plotY || 0) + e.plotTop, x;
            ...
            class C {
                ...
                optionsToObject(t) {
                    ...
                    if (m(t) || null === t) r[s[0]] = t;
                        ...
                        for (!i && t.length > o && ("string" == (n = typeof t[0]) ? r.name = t[0] : "number" === n && (r.x = t[0]), a++); h < o;) i && void 0 === t[a] || (s[h].indexOf(".") > 0 ? C.prototype.setNestedProperty(r, t[a], s[h]) : r[s[h]] = t[a]), a++, h++;
            ...
            class C {
                ...
                colorizeItem(t, e) {
                    ...
                    if (i && i[e ? "removeClass" : "addClass"]("highcharts-legend-item-hidden"), !this.chart.styledMode) {
                        let {
                            itemHiddenStyle: i
                        } = this, n = i.color, a = e && t.color || n, h = t.options && t.options.marker, l = {
                            fill: a
                        };
                ...
                positionItem(t) {
                    let {
                        ...
                        x: i = 0,
                        y: s = 0
                    } = t.legendItem || {}, o = this.options, r = o.symbolPadding, n = !o.rtl, a = t.checkbox;
                    if (e && e.element) {
                        let o = {
                ...
                handleOverflow(t) {
                    let e = this,
                        ...
                        m, x, y, b = i.spacingBox.height + (n ? -r : r) - a,
                        k = this.nav,
                        S = this.clipRect;
            ...
            class X {
                    ...
                    if (l && l.enabled && (t = this.sortData(t)), h.options.chart.allowMutatingData && !1 !== s && C && n && !o.cropped && !o.hasGroupedData && o.visible && !o.boosted && (b = this.updateData(t, i)), !b) {
                        if (o.xIncrement = null, o.colorCounter = 0, this.parallelArrays.forEach(function(t) {
                            ...
                            if (B(S = o.getFirstValidPoint(t)))
                                for (x = 0; x < C; x++) p[x] = this.autoIncrement(), u[x] = t[x];
                            else if (I(S)) {
                                if (f) {
                                    if (S.length === f)
                                        for (x = 0; x < C; x++) p[x] = this.autoIncrement(), u[x] = t[x];
                                    else
                                        for (x = 0; x < C; x++) y = t[x], p[x] = y[0], u[x] = y.slice(1, f + 1)
                                } else if (m && (v = m.indexOf("x"), k = m.indexOf("y"), v = v >= 0 ? v : 0, k = k >= 0 ? k : 1), 1 === S.length && (k = 0), v === k)
                                    for (x = 0; x < C; x++) p[x] = this.autoIncrement(), u[x] = t[x][k];
                                else
                                    for (x = 0; x < C; x++) y = t[x], p[x] = y[v], u[x] = y[k]
                            } else T(12, !1, h)
                        } else
                            for (x = 0; x < C; x++) y = {
                                series: o
                ...
                generatePoints() {
                    ...
                    if (this.options.keys = h, f && (r !== (c = f.length) || a))
                        for (g = 0; g < c; g++) g !== n || a || (g += r), f[g] && (f[g].destroyElements(), f[g].plotX = void 0);
                ...
                getExtremes(t, e) {
                    ...
                    let y = t.length;
                    for (i && (f = (h = i.getExtremes()).min, m = h.max), u = 0; u < y; u++)
                        if (c = o[u], l = (B(p = t[u]) || I(p)) && ((B(p) ? p > 0 : p.length) || !a), d = e || this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || !i || (o[u + n] || c) >= f && (o[u - n] || c) <= m, l && d) {
                            if (g = p.length)
                                for (; g--;) B(p[g]) && (r[x++] = p[g]);
                            else r[x++] = p
                        } let k = {
                ...
                setClip() {
                    let {
                        ...
                        group: e,
                        markerGroup: i
                    } = this, s = t.sharedClips, o = t.renderer, r = this.getClipBox(), n = this.getSharedClipKey(), a = s[n];
                ...
                animate(t) {
                    let {
                        ...
                        group: i,
                        markerGroup: s
                    } = this, o = e.inverted, r = d(this.options.animation), n = [this.getSharedClipKey(), r.duration, r.easing, r.defer].join(","), a = e.sharedClips[n], h = e.sharedClips[n + "m"];
                    if (t && i) {
                ...
                pointAttribs(t, e) {
                    let i = this.options.marker,
                        ...
                        h, l, d = this.color,
                        c, p, u = N(o.lineWidth, i.lineWidth),
                        g = 1;
                ...
                isPointInside(t) {
                    let {
                        ...
                        xAxis: i,
                        yAxis: s
                    } = this, o = void 0 !== t.plotY && void 0 !== t.plotX && t.plotY >= 0 && t.plotY <= (s ? s.len : e.plotHeight) && t.plotX >= 0 && t.plotX <= (i ? i.len : e.plotWidth);
                    return o
                }
                drawTracker() {
                    let t = this,
                ...
                setState(t, e) {
                    ...
                    if (t = t || "", i.state !== t && ([i.group, i.markerGroup, i.dataLabelsGroup].forEach(function(e) {
                        ...
                        if (t && (l = n[t].lineWidth || l + (n[t].lineWidthPlus || 0), c = N(n[t].opacity, c)), o && !o.dashstyle && B(l))
                            for (h = {
                                    "stroke-width": l
            ...
            class J {
                ...
                redraw(t) {
                    ...
                    let e = this.hasCartesianSeries ? this.axes : this.colorAxis || [],
                        ...
                        g;
                    for (n.rootFontSize = n.boxWrapper.getStyle("font-size"), this.setResponsive && this.setResponsive(!1), f(!!this.hasRendered && t, this), a && this.temporaryDisplay(), this.layOutTitles(!1), c = i.length; c--;)
                ...
                getContainer() {
                    ...
                    if (this.renderer = new u(c, h, d, void 0, e.forExport, t.exporting && t.exporting.allowHTML, this.styledMode), this.containerBox = this.getContainerBox(), f(void 0, this), this.setClassName(e.className), this.styledMode)
                ...
                getGraphPath(t, e, i) {
                    ...
                    return d && t.reverse(), (l = ({
                        ...
                        (d.leftCliff || f && f.rightCliff) && !i && (h = !0), m && !s(e) && c > 0 ? h = !r.connectNulls : m && !e ? h = !0 : (0 === c || h ? p = [
                            ["M", d.plotX, d.plotY]
                        ] : o.getPointSpline ? p = [o.getPointSpline(t, d, c)] : l ? (p = 1 === l ? [
                            ["L", f.plotX, g]
                        ] : 2 === l ? [
            ...
            return function(t) {
                ...
                function m(t, e, i, s, o) {
                    let r = this,
                        ...
                        y, b, v, k = "justify" === u(i.overflow, d ? "none" : "justify"),
                    ...
                    if (S && M) {
                        ...
                        if (y = h.renderer.fontMetrics(e).b, s = a({
                            ...
                            }, n = [t.x - Number(e.attr("x")), t.y - Number(e.attr("y"))], x(v), e[o ? "attr" : "animate"](v)) : (x(s), e.align(i, void 0, s), v = e.alignAttr), k && s.height >= 0) this.justifyDataLabel(e, i, v, t, s, o);
                        else if (u(i.crop, !0)) {
                            let {
                                x: e,
                                y: i
                ...
                connectorShapes: {
                    ...
                    crookedLine: function(t, e, i) {
                        let {
                            ...
                            series: r
                        } = this, [n, a, h] = r.center, l = h / 2, {
                            plotLeft: c,
                            plotWidth: p
                        } = r.chart, u = "left" === t.alignment, {
                            x: g,
                            y: f
                        } = t, m = s.x;
                        if (i.crookDistance) {
            ...
            return function(e) {
                ...
                function r(t, e) {
                    let {
                        center: i,
                        options: s
                    } = this, o = i[2] / 2, r = t.angle || 0, n = Math.cos(r), a = Math.sin(r), h = i[0] + n * o, l = i[1] + a * o, d = Math.min((s.slicedOffset || 0) + (s.borderWidth || 0), e / 5);
                    return {
                        natural: {
                            x: h + n * e,
                            y: l + a * e
                        ...
                        h && (t.sortByAngle(e, n - .5), S > 0 && (u = Math.max(0, f - g - S), m = Math.min(f + g + S, i.plotHeight), e.forEach(t => {
                            ...
                            (i.dataLabels || []).forEach(a => {
                                let h = a.options || {},
                                    ...
                                    C = "inherit";
                                if (f) {
                                    if (l && c(u) && f.distance > 0 && (void 0 === u.pos ? C = "hidden" : (k = u.size, M = y.radialDistributionY(i, a))), h.justify) S = y.justify(i, a, g, d);
            ...
            function m() {
                if (this.options.borderRadius && !(this.chart.is3d && this.chart.is3d())) {
                    let {
                        options: t,
                        yAxis: e
                    } = this, i = "percent" === t.stacking, o = s.plotOptions?.[this.type]?.borderRadius, r = x(t.borderRadius, a(o) ? o : {}), h = e.options.reversed;
        ...
        a(t, "Extensions/DownloadURL.js", [t["Core/Globals.js"]], function(e) {
            ...
            return {
                ...
                downloadURL: function(e, n) {
                    ...
                    if (void 0 !== s.download) s.href = e, s.download = n, o.body.appendChild(s), s.click(), o.body.removeChild(s);
                    else try {
            ...
            function H(e) {
                ...
                a.push(function(e, t, a) {
                    ...
                    if (i && e && t && !h(e, t)) {
                        ...
                        for (; r < s; ++r)
                            if ((l = e[r]) === e[r + 1]) ++d;
                            else if (d) a.push(c("th", "highcharts-table-topheading", {
                            scope: "col",
                            colspan: d + 1
                        }, l)), d = 0;
                        else {
...
<script>
    Highcharts.chart('container', {
        ...
        title: {
            text: 'Jumlah Laporan Perbulan - 2023',
            align: 'left'
        },
        ...
        series: [{
            name: 'Total Jumlah Laporan',
            data: [
                <?= $januari; ?>, <?= $februari; ?>, <?= $maret; ?>, <?= $april; ?>, <?= $mei; ?>, <?= $juni; ?>, <?= $juli; ?>, <?= $agustus; ?>, <?= $september; ?>, <?= $oktober; ?>, <?= $november; ?>, <?= $desember; ?>
            ]
        }, {
            name: 'Jumlah Laporan Belum Di Validasi',
            data: [
                <?= $januariF; ?>, <?= $februariF; ?>, <?= $maretF; ?>, <?= $aprilF; ?>, <?= $meiF; ?>, <?= $juniF; ?>, <?= $juliF; ?>, <?= $agustusF; ?>, <?= $septemberF; ?>, <?= $oktoberF; ?>, <?= $novemberF; ?>, <?= $desemberF; ?>
            ]
        }, {
            name: 'Jumlah Laporan Sudah Di Validasi',
            data: [
                <?= $januariY; ?>, <?= $februariY; ?>, <?= $maretY; ?>, <?= $aprilY; ?>, <?= $meiY; ?>, <?= $juniY; ?>, <?= $juliY; ?>, <?= $agustusY; ?>, <?= $septemberY; ?>, <?= $oktoberY; ?>, <?= $novemberY; ?>, <?= $desemberY; ?>
            ]
        }],
