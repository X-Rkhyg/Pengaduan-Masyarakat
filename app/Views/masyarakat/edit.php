                    ...
                    <div class="card">
                        ...
                        <?php endif; ?>
                            <form action="/pengaduan/update/<?= $aduan['id_pengaduan']; ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-1"><label for="name" class="form-label form-label">Isi Laporan <font color="FF7F7F">*</font></label><textarea name="isi_laporan" placeholder="Laporan Anda" value="<?= (old('isi_laporan')) ? old('isi_laporan') : $aduan['isi_laporan'] ?>" type="text" class="form-control"></textarea></div>
