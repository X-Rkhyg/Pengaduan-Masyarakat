                    ...
                    <div class="card">
                        ...
                        <?php endif; ?>
                            <form action="/pengaduan/update/<?= $aduan['id_pengaduan']; ?>" method="post" enctype="multipart/form-data">
                                ...
                                <!-- upload foto -->
                                <div class="mb-1"><label for="foto" class="form-label form-label">Foto<font color="FF7F7F">*</font></label><input name="foto" placeholder="Laporan Anda" value="<?= (old('foto')) ? old('foto') : $aduan['foto'] ?>" type="file" class="form-control"></div>
